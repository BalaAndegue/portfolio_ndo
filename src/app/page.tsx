  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-50 font-sans selection:bg-purple-500/30">
      ...
      <div className="relative z-10 flex flex-col items-center">
        {/* Navigation / Header */}
        <header className="w-full max-w-5xl mx-auto py-8 px-6 flex justify-between items-center animate-fade-in-down">
        ...
        <main className="w-full max-w-5xl mx-auto px-6 pb-24 flex flex-col items-center">
          ...
          {/* Hero Section */}
          <section className="w-full flex md:flex-row flex-col-reverse items-center justify-between gap-12 mt-16 md:mt-24 mb-32">
            <div className="flex-1 flex flex-col items-start gap-6 relative group">
              {/* Decorative line */}
              <div className="w-12 h-1 bg-gradient-to-r from-purple-500 to-blue-500 rounded-full mb-2"></div>
            ...
            <div className="relative w-64 md:w-80 h-64 md:h-80 shrink-0">
              {/* Animated rings */}
              ...
              <div className="relative w-full h-full rounded-full overflow-hidden bg-zinc-800 border-2 border-zinc-700/50 shadow-2xl p-1 group-hover:p-2 transition-all duration-500">
                <div className="w-full h-full rounded-full overflow-hidden relative bg-zinc-900 flex items-center justify-center">
                  <Image
                    ...
                    priority
                  />
                  {/* Fallback pattern overlay to emphasize the 'placeholder/professional' look */}
          ...
          {/* Experience Section */}
          <section id="experience" className="w-full mb-32 pt-16 scroll-mt-16">
            ...
            <div className="relative pl-8 md:pl-0">
              ...
              <div className="relative flex md:justify-between items-center md:items-start group w-full mb-12">
              ...
              <div className="relative flex md:justify-between items-center md:items-start group w-full">
          ...
          <section className="w-full mb-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Skill 1 */}
              <div className="group relative bg-zinc-900/40 p-8 rounded-3xl border border-zinc-800/80 hover:border-purple-500/50 transition-all duration-500 overflow-hidden">
              ...
              {/* Skill 2 */}
              <div className="group relative bg-zinc-900/40 p-8 rounded-3xl border border-zinc-800/80 hover:border-pink-500/50 transition-all duration-500 overflow-hidden">
              ...
              {/* Skill 3 */}
              <div className="group relative bg-zinc-900/40 p-8 rounded-3xl border border-zinc-800/80 hover:border-blue-500/50 transition-all duration-500 overflow-hidden">
          ...
          {/* Services Section */}
          <section className="w-full mb-32 pt-16 scroll-mt-16">
            <div className="flex items-center gap-4 mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="p-8 rounded-3xl bg-gradient-to-b from-zinc-900 to-zinc-950 border border-zinc-800/80 hover:border-zinc-700 transition-all duration-300 group">
          ...
          <section className="w-full mb-32 pt-16 scroll-mt-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {/* Project 1 */}
              <div className="group rounded-3xl overflow-hidden bg-zinc-900 border border-zinc-800 hover:border-purple-500/50 transition-all duration-500 flex flex-col">
              ...
              {/* Project 2 */}
              <div className="group rounded-3xl overflow-hidden bg-zinc-900 border border-zinc-800 hover:border-blue-500/50 transition-all duration-500 flex flex-col">
                <div className="relative w-full h-64 overflow-hidden bg-zinc-800">
                  <div className="absolute inset-0 bg-gradient-to-t from-zinc-900/90 to-transparent z-10"></div>
                  <Image
          ...
          {/* Tools & Tech Section */}
          <section className="w-full mb-16 pt-16 border-t border-zinc-800/50">
        ...
        <footer className="w-full border-t border-zinc-800/50 py-12 flex flex-col items-center justify-center gap-6 mt-10">
